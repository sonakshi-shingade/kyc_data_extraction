...
class PanCardDetails:
    ...
    def extract_text(self, file_path: str) -> None:
        """
        Extract text from an image using pytesseract OCR.

        Args:
            file_path (str): The file path to the PAN card image.
        """
        try:
            self.text = pytesseract.image_to_string(file_path)
    ...
    def get_pan_details(self, file_path: str) -> Dict[str, Optional[str]]:
        """
